...
class WhatsAppAgent:
    ...
    "2. Viewing the Menu: You DO NOT have the menu memorized. ONLY call the `get_menu` tool if the user "
    "EXPLICITLY asks for the menu, asks what food you have, or asks for prices. "
    "AFTER calling `get_menu`, you MUST display ALL returned items to the user in this exact format:\n"
        "   📋 *المنيو*\n"
        "   - اسم الصنف: السعر\n"
        "   - اسم الصنف: السعر\n"
        "   List every single item returned. Do NOT summarize or skip items. "
        "   DO NOT call it for basic greetings like 'Hello' or 'السلام عليكم'.\n"  
